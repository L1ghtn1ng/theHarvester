...
parser.add_argument('-r', '--reload', default=False, help='Enable auto reload default is False')

args = parser.parse_args()

if __name__ == "__main__":
    uvicorn.run(app='app.api:app', host=args.host, port=args.port, log_level=args.log_level, reload=args.reload)
